...
namespace UrGUI.Utils
{
    public class INIParser
    {
        ...
        {
            string StringValue = ReadValue(SectionName, Key, "#" + ColorUtility.ToHtmlStringRGB(DefaultValue));
            Color Value;
            if (ColorUtility.TryParseHtmlString(StringValue, out Value)) return Value;
            return DefaultValue;
        }
